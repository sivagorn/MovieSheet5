...
.movie-card-container {
  ...
  padding: 20px; /* เพิ่ม padding เล็กน้อยถ้าต้องการ */
}
...
.movie-card {
  ...
  border-radius: 20px;
  padding: 20px;
  width: 80%; /* เปลี่ยนเป็น 80% สำหรับหน้าจอมือถือ */
  max-width: 400px; /* ขนาดสูงสุดสำหรับมือถือ */
  z-index: 2;
  margin: auto; /* ใช้ margin auto เพื่อให้การ์ดอยู่กลาง */
}
...
@media (max-width: 768px) {
  .movie-card {
    /* ไม่ต้องใช้ margin-top อีกต่อไป */
  }
}

@media (min-width: 768px) {
  .movie-card {
    max-width: 700px; /* ขนาดสำหรับแท็บเล็ต */
  }
}

@media (min-width: 1024px) {
  .movie-card {
    max-width: 900px; /* ขนาดสำหรับ desktop */
  }
}
